...
{{- $messages := list -}}
{{- $messages := append $messages (include "opensearch-dashboards.validateValues.noOpensearch" .) -}}
...
{{/* Validate values of Opensearch Dashboards - must provide an Opensearch */}}
{{- define "opensearch-dashboards.validateValues.noOpensearch" -}}
...
{{/*
Return the cert-manager issuer
*/}}
{{- define "opensearch-dashboards.issuerName" -}}
